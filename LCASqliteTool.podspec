...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LCASqliteTool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/931985308@qq.com/LCASqliteTool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '931985308@qq.com' => 'lichangan' }
  s.source           = { :git => 'https://github.com/931985308@qq.com/LCASqliteTool.git', :tag => s.version.to_s }
